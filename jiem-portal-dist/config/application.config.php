 ...
 * - Aapache environment variable defined in .
 *
 *
 *
 *
...
// 'History'
 // This module created for Resful API
...
return array(
    ...
    'module_listener_options' => array(
        ...
        'config_glob_paths' => array(
            ...
            'config/autoload/{{,*.}global,{,*.}local,*.'.$env.'{,*.}messages}.php',
            'config/autoload/'.$env.'/{{,*.}global,{,*.}local,{,*.}messages}.php'
        ),
        ...
        'config_cache_key' => $env . '-jiemdp-config',
        ...
        'module_map_cache_key' => $env . '-jiemdp-module-map',
